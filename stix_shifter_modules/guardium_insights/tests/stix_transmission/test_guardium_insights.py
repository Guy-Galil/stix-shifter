from stix_shifter_modules.guardium_insights.entry_point import EntryPoint
...
@patch('stix_shifter_modules.guardium_insights.stix_transmission.api_client.APIClient.__init__', autospec=True)
class TestGuardiumConnection(unittest.TestCase, object):
    ...
    @patch('stix_shifter_modules.guardium_insights.stix_transmission.api_client.APIClient.create_search')
    def test_query_response(self, mock_query_response, mock_api_client):
        ...
        transmission = stix_transmission.StixTransmission('guardium_insights',  connection, config)
    ...
    @patch('stix_shifter_modules.guardium_insights.stix_transmission.api_client.APIClient.get_search_results', autospec=True)
